// js/script.js
// الكود الكامل والنهائي للموقع، مُحصّن ضد الأخطاء ومُحسّن للأداء.
// يحتوي على البيانات والكود الوظيفي في ملف واحد.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    /**
     * @module DataRenderer
     * @description وحدة مسؤولة عن عرض البيانات الديناميكية في الصفحات المختلفة.
     */
    const DataRenderer = {
        
        /**
         * @private
         * @function _activateFlipCards
         * @description دالة مساعدة خاصة لتفعيل وظيفة القلب على مجموعة محددة من البطاقات.
         * @param {string} containerSelector - مُحدد CSS للحاوية التي تحتوي على البطاقات.
         */
        _activateFlipCards(containerSelector) {
            const container = document.querySelector(containerSelector);
            if (!container) return;

            container.querySelectorAll('.flip-card').forEach(card => {
                // التأكد من عدم إضافة نفس الحدث مرتين
        ...
        loadOfficials() {
            ...
            // تفعيل البطاقات في كل قسم على حدة
            this._activateFlipCards('#rulers-cards-container');
            this._activateFlipCards('#guild-leaders-cards-container');
        },
        ...
        loadAchievements() {
            ...
            this._activateFlipCards('#achievements-container');
        },
        ...
        loadStats() {
            ...
            this._activateFlipCards('#stats-container');
        }
    };
