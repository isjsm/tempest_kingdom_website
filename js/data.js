...
const achievementsData = [
  {
    "front": {
      "title": "إنجازات الحروب",
      "icon": "fa-solid fa-shield-halved"
    },
    "back": {
      "title": "سجل الانتصارات",
      "items": [
        "الانتصار في حرب الملوك الأولى",
        "تحقيق المركز الأول في بطولة النقابات",
        "صد هجوم تحالف الظلام بنجاح",
        "الحصول على لقب 'المملكة التي لا تقهر'"
      ]
    }
  },
  {
    "front": {
      "title": "إنجازات الفعاليات",
      "icon": "fa-solid fa-calendar-check"
    },
    "back": {
      "title": "أبرز الفعاليات الناجحة",
      "items": [
        "تنظيم أكبر مسابقة فنية بمشاركة 100+ فنان",
        "استضافة 'ليلة الأنمي الكلاسيكي' بنجاح",
        "تحقيق رقم قياسي في عدد الحضور بفعالية 'أسئلة وأجوبة'",
        "الفوز بجائزة أفضل تنظيم فعالية لعام 2025"
      ]
    }
  },
  {
